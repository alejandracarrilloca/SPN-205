...
and SPN-202 (principal SPN isoforms) into a single "canonical SPN" expression file for GTEx data. 

"""

import pandas as pd

file1 = "results/Transcripts/SPN-201/SPN-201_GTEx_expression.tsv"
file2 = "results/Transcripts/SPN-202/SPN-202_GTEx_expression.tsv"
output_file = "results/Transcripts/SPN/SPN_GTEx_expression.tsv"
