...
aln_file = "results/alignments/spn.cdna.mafft.fa"  # This must be an aligned FASTA
...
print("Full-length pairwise cDNA percent identity matrix saved to results/alignments/cdna_pairwise.tsv")
